...
import 'register_page_mahasiswa.dart';
    ...
    try {
      ...
      if (user != null) {
        ...
        if (userDoc.exists) {
          ...
          if (role == 'dosen') {
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => DosenHomePage()));
          } else if (role == 'mahasiswa') {
            if (_rememberMe) {
              _savePreferences(_emailController.text.trim());
            } else {
              _clearPreferences();
            }
            Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => MahasiswaHomePage()));
          } else {
